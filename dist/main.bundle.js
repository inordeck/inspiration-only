...
module.exports = "<router-outlet></router-outlet>\n<div class=\"container\">\n\t<div class=\"row\">\n\t\t<div class=\"col-2\"></div> <!-- WHITESPACE -->\n\n\t\t<div class=\"col-8\">\n\t\t\t<div class=\"card\">\n\t\t\t  <h1 class=\"card-header\">SIGNUP</h1>\n\t\t\t  <div class=\"card-block\">\n\t\t\t    <h4 class=\"card-title\">Thanks you for signing up and participating.</h4>\n\t\t\t    <p class=\"card-text\">Sign up with you google account or by setting and email and password.</p>\n\t\t\t\t<form>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"firstName\">First Name</label>\n\t\t\t\t\t\t<input type=\"firstName\" class=\"form-control\" id=\"firstName\" placeholder=\"Enter first name\">\n\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"lastName\">Last Name</label>\n\t\t\t\t\t\t<input type=\"lastName\" class=\"form-control\" id=\"lastName\" placeholder=\"Enter last name\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"exampleInputEmail1\">Email address</label>\n\t\t\t\t\t\t<input type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\">\n\t\t\t\t\t\t<small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"exampleInputPassword1\">Password</label>\n\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"buttons\">\n\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary\" routerLink=\"/send-story\">SIGNUP</button>\n\t\t\t\t\t\t<p>or</p>\n\t\t\t\t\t\t<button class=\"btn btn-success\" (click)=\"loginWithGoogle()\">SIGN UP WITH GOOGLE</button>\n\t\t\t\t\t</div>\n\t\t\t\t</form>  <!-- end of form -->\n\t\t\t\t</div> <!-- end of card block -->\n\t\t\t</div> <!-- end of card -->\n\t\t</div> <!-- end of col 8 -->\n\n\t\t<div class=\"col-2\"></div> <!-- WHITESPACE -->\n\t</div> <!-- end of row -->\n</div> <!-- end of container -->\n\n"
